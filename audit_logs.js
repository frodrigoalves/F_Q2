const RAW_LOGS = [
    '{ "event": "user_input", "data": "Tell me about my legacy.", "source": "singulai_orchestrator" }',
    '{ "node": "vector_search", "query": "pedro_financial_2024", "matches": 3 }',
    '{ "system": "singulai", "model": "atlas-v2", "status": "streaming", "tokens": 128 }',
...
const INSIGHTS = [
    ...
    { label: "NEURAL INFERENCE", msg: "SingulAI inference completed within the sovereign enclave. No data leakage detected." },
